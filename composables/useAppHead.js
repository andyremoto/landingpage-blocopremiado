...
export const useAppHead = () => {
  useHead({
    ...
    meta: [
      ...
      {
        name: 'keywords',
        content: 'bloco premiado, tokens EQ9, iPhone 16, sorteio, cripto, blockchain, tokens, congelar dinheiro, ganhar iPhone'
      },
      {
        property: 'og:title',
      ...
      },
      {
        ...
        content: 'Transforme reais em tokens EQ9, congele-os e ganhe tickets para o sorteio do iPhone 16. Suas tokens continuam sendo suas e podem valorizar!'
      },
      {
        property: 'og:image',
      ...
      },
      {
        ...
        content: 'Transforme reais em tokens EQ9, congele-os e ganhe tickets para o sorteio do iPhone 16.'
      },
      {
        name: 'twitter:image',
        content: '/images/bloco-premiado-share.jpg'
